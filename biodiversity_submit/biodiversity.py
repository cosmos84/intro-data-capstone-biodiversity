...
num_species = len(different_species)
...
num_categories = len(different_categories)
print(different_categories, num_categories)
...
list_conservation_status = species.conservation_status.unique()
population_conservation_status=pd.value_counts(species['conservation_status'].values)
print(different_conservation_status)
print(population_conservation_status)
...
chi2, pval_1, dof, expected = chi2_contingency(contingency)
print (pval_1)
...
contingency_rept_mamm = [[176,38],[74,5]]
chi2, pval_2, dof, expected = chi2_contingency(contingency_rept_mamm)
print (pval_2)
...
sheeps =species[species.is_sheep]
sheeps.head(20)
...
sample_bryce = 510/250.
sample_yellow = 510/507.
